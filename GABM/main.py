...
if __name__ == "__main__":
    ...
    parser.add_argument("--contact_rate", default=4, type=int, help="Contact Rate")
    ...
    parser.add_argument("--no_days", default=100, type=int,
    ...
    #openAIkey
    openai.api_key = ""
    openai.api_base = "http://localhost:8000/v1" #API服务器，可能会报错
