...
system_prompt = f"""
        ...
        john checks the newspaper and finds that 0.1% of Dewberry Hollow's population caught new infections of the Catasat virus yesterday.
        john goes to work to earn money to support john's self.And this is very important for john.

        Based on your traits,age,health condition,daily infection rate and work need, should john stay at home for the entire day? Please provide your reasoning.
        ...
        please pay atention
        "Yes" means staying at home,"No" means going to work,you "Response" must align with "Reasoning". 
